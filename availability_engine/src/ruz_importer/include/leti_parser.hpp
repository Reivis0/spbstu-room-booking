#ifndef LETI_PARSER_HPP
#define LETI_PARSER_HPP

#include "university_parser.hpp"
#include "http_client.hpp"

class LetiParser : public UniversityParser {
public:
    ...
    std::string getUniversityID() const override { return "leti"; }
    
    // Специальный метод для LETI, возвращающий все записи разом
    std::vector<ScheduleRecord> fetchAll();
